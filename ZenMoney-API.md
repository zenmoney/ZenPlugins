...
Если вам нужен просто токен для работы с API Дзен-мани, то получить его вы можете без регистрации у любого из ранее зарегистрировавшегося в Дзен-мани сервиса. Например, отсюда – [Zerro.app](https://zerro.app/token).
