      ...
      [
        {
          ...
          details: {
            ...
            isDebitBlocked: 'true',
            replenishmentPurpose: 'Поповнення рахунку ФОП АНТОНОВ Р. О.',
            cardsList: [],
            rateId: null,
            overInterestRate: '',
            overAmount: '',
            ownerName: 'ФОП АНТОНОВ Р. О.',
            lastTransactionDate: '13.09.2021',
          ...
          details:
            {
              ...
              bankName: 'АТ "КРЕДОБАНК"',
              isDebitBlocked: 'false',
              replenishmentPurpose: 'Поповнення рахунку ФОП Голей М. І.',
              cardsList: [],
              rateId: null,
              overInterestRate: '',
              overAmount: '',
              ownerName: 'ФОП Голей М. І.',
              lastTransactionDate: '11.11.2021',
              isBtnMobInformChangeAvailable: 'false',
              creditLimit: null,
              overDealId: '',
