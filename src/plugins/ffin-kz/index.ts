import { ScrapeFunc, Account, Transaction, Movement } from '../../types/zenmoney'
...
function mergeCounterparts (transactions: Transaction[]): Transaction[] {
...
function dedupeSinglesAgainstTransfers (transactions: Transaction[]): Transaction[] {
