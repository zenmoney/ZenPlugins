...
async function levelUp (auth, codewordOnly) {
  ...
  const title = codewordOnly
    ? 'Для синхронизации дебетовых карт и депозитов введите кодовое слово. Оставьте это поле пустым, если у вас в банке Хоум Кредит только кредит или кредитная карта.'
    : 'Для синхронизации дебетовых карт и депозитов введите кодовое слово или номер дебетовой карты. Оставьте это поле пустым, если у вас в банке Хоум Кредит только кредит или кредитная карта.'
