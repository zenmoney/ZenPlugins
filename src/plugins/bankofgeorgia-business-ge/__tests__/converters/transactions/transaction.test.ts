...
describe('convertToZenMoneyTransaction', () => {
  it.each([
    ...
    [
      ...
      {
        Currency: 'GEL',
        AccountID: 'GE11BG0000000536190228GEL',
        EntryDate: '2025-12-15T00:00:00',
        EntryDocumentNumber: 'FEE',
        EntryAccountNumber: '64049811540200000000',
        EntryAmountDebit: 5,
        EntryAmountDebitBase: 5,
        EntryAmountCredit: 0,
        EntryAmountCreditBase: null,
        EntryAmountBase: 5,
        EntryAmount: -5,
        EntryComment: 'Business Package S პაკეტის მომსახურების საკომისიო ',
        EntryDepartment: 'CENT14',
        EntryAccountPoint: 'CENTRAL14',
        DocumentProductGroup: 'FEE',
        DocumentValueDate: '2025-12-15T00:00:00',
        SenderDetails: {
          Name: 'ინდივიდუალური მეწარმე ევგენიი ტროიცკიი',
          Inn: '302216331',
          AccountNumber: 'GE11BG0000000536190228GEL',
          BankCode: 'BAGAGE22',
        ...
        BeneficiaryDetails: {
          Name: '',
          Inn: null,
          AccountNumber: '64049811540200000000',
          BankCode: 'BAGAGE22',
          BankName: 'სს "საქართველოს ბანკი"'
        },
        DocumentTreasuryCode: null,
        DocumentNomination: 'Business Package S პაკეტის მომსახურების საკომისიო ',
        DocumentInformation: 'Business Package S პაკეტის მომსახურების საკომისიო ',
        DocumentSourceAmount: 5,
        DocumentSourceCurrency: 'GEL',
        DocumentDestinationAmount: 5,
        DocumentDestinationCurrency: 'GEL',
        DocumentReceiveDate: '2025-12-16T00:00:00',
        DocumentBranch: '502',
        DocumentDepartment: 'ISAN01',
        ...
        DocumentPayee: null,
        DocumentCorrespondentAccountNumber: '64049811540200000000',
        DocumentCorrespondentBankCode: 'BAGAGE22',
        DocumentCorrespondentBankName: 'სს "საქართველოს ბანკი"',
        DocumentKey: 30918157368,
        EntryId: 107834080207,
        DocumentPayerName: 'ინდივიდუალური მეწარმე ევგენიი ტროიცკიი',
        DocumentPayerInn: '302216331',
        DocComment: null
      },
      {
        comment: 'Business Package S პაკეტის მომსახურების საკომისიო ',
        date: new Date('2025-12-15T00:00:00'),
        hold: false,
        merchant: null,
        movements: [
          {
            account: { id: 'GE11BG0000000536190228GEL' },
            fee: 0,
            id: '107834080207',
            invoice: null,
            sum: -5
